...
- [ ] (Pablo) Finish the PDF exporter — install `docs/spreadsheet-automation/curriculum-pdf-apps-script.js` into the Curriculum Spreadsheet's Apps Script editor, test both PDF outputs, and adjust styling/content as needed
